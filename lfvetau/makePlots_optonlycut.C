...
self.book(f, "h_collmass_pfmet",  "h_collmass_pfmet",  32, 0, 320)
  for(int i=20;i<=binnumb;i++)
     {
         signal= hLFVvbf->GetBinContent(i)+hLFVgg->GetBinContent(i);
         background=hW1Jets->GetBinContent(i)+hW2Jets->GetBinContent(i)+hW3Jets->GetBinContent(i)+hW4Jets->GetBinContent(i)+hGGHTT->GetBinContent(i)+hTTJetsFLMGD->GetBinContent(i)+hTTJetsSLMGD->GetBinContent(i)+hT_tZ2star->GetBinContent(i)+hT_twZ2star->GetBinContent(i)+ hTbar_tZ2star->GetBinContent(i)+hTbar_twZ2star->GetBinContent(i)+hWWJets->GetBinContent(i)+hWZJets->GetBinContent(i)+ hZ0jetsTT->GetBinContent(i)+ hZ1jetsTT->GetBinContent(i)+hZ2jetsTT->GetBinContent(i)+hZ3jetsTT->GetBinContent(i)+hZ4jetsTT->GetBinContent(i)+hZZjets->GetBinContent(i)+hZetauA->GetBinContent(i)+hZetauB->GetBinContent(i)+hZetauC->GetBinContent(i)+hZetauD->GetBinContent(i);
