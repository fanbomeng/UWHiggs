...
_0jets = {
   'tPt'  : range(30,50,10)+[35,45,50],
  # 'tPt'  : [50],
   'ePt'  : range(30,50,10)+[35,45,50],
  # 'ePt'  : [50,55],
   'dphi' : [3.00, 2.7,2.5,2.4, 2.2],
  # 'dphi' : [2.1,2.5],
   'tMtToPfMet' : range(30,70,10)+[55,65,75],#was [20,50,10]+[35]
  # 'tMtToPfMet' :[70,75],#was [20,50,10]+[35]
}
_0jets_default = {
   'tPt' : 30,
   'ePt' : 45,     #was 50
   'dphi': 2.3,    #was 2.3
   'tMtToPfMet' :70,  #was 50
}
...
_1jets = {
  ...
  #  'ePt'  : [33],
    'tMtToPfMet' : range(30,50,10)+[35,45,55],
 #   'tMtToPfMet' : [45,50,55],
}
_1jets_default = {
    'tPt' :40,#was 30
    'ePt' : 35,#was 40
    'tMtToPfMet' :40,#was 35
}
...
_2jets = {
    ...
    'ePt'  : range(30,50,10)+[35,45],
    'tMtToPfMet' : range(30,60,10)+[35,45],
    'vbf_mass' : range(400, 600, 100) + [450,550],
    'vbf_deta' : [2.2,2.5,2.7,3.0,3.5, 4.0],
    #'tPt'  : [33],
    #'ePt'  : [33],
    #'tMtToPfMet' :[55,60],
    #'vbf_mass' : [450,475,525],
    #'vbf_deta' : [2.2,2.7,3.3],
}
_2jets_default = {
    'tPt' : 35,#30
    'ePt' : 35,#40
    'tMtToPfMet' : 50,#was 35
    'vbf_mass' : 500,#was 400
    'vbf_deta' : 2.3,#was 2.5
}
