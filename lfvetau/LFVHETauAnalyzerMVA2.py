...
class LFVHETauAnalyzerMVA2(MegaBase):
    tree = 'et/final/Ntuple'
    def __init__(self, tree, outfile, **kwargs):
        logging.debug('LFVHETauAnalyzerMVA2 constructor')
        self.channel='ET'
        super(LFVHETauAnalyzerMVA2, self).__init__(tree, outfile, **kwargs)
...
#                )
     ...
     #       logging.debug('Passed Vetoes') 
            ...
            jet0refer=(30,30,2,70)
            jet1refer=(30,30,70)
            jet2refer=(30,30,70,400,2)
