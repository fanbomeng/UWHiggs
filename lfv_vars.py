...
collMass_type1 = ("collinear M(#mu#tau_{h}) (GeV)",20,"ROOT.TLegend(0.63,0.60,0.93,0.97,' ','brNDC')",100,100,True,300,20, "ROOT.TLegend(0.52,0.45,0.87,0.95,' ','brNDC')")
...
mPt = ("#mu P_{T} [GeV]",5,"ROOT.TLegend(0.6,0.55,0.81,0.99,' ','brNDC')",0,0,True,0,10,"ROOT.TLegend(0.52,0.45,0.87,0.95,' ','brNDC')")

tPt = ("#tau P_{T} [GeV]",10,"ROOT.TLegend(0.55,0.50,0.85,0.87,' ','brNDC')",0,0,True,100,10,"ROOT.TLegend(0.52,0.45,0.87,0.95,' ','brNDC')")

tJetPt = ("Tau Jet P_{T}" , 10,"ROOT.TLegend(0.55,0.45,0.8,0.85,' ','brNDC')",0,0,True,0,10,"ROOT.TLegend(0.52,0.45,0.87,0.95,' ','brNDC')")

mEta = ("Muon #eta",10,"ROOT.TLegend(0.13,0.6,0.33,0.9,' ','brNDC')",0,0,False,0,10,"ROOT.TLegend(0.52,0.45,0.87,0.95,' ','brNDC')")

tEta = ("Tau #eta",10,"ROOT.TLegend(0.7,0.65,0.9,0.88,' ','brNDC')",-1,1,False,0,10,"ROOT.TLegend(0.52,0.45,0.87,0.95,' ','brNDC')")

mMtToPfMet_Ty1 = ("#mu,MET M_{T} [GeV]",5,"ROOT.TLegend(0.6,0.6,0.8,0.8,' ','brNDC')",0,0,True,0,10,"ROOT.TLegend(0.6,0.6,0.8,0.8,' ','brNDC')")

tMtToPfMet_Ty1 = ("#tau,MET M_{T} Ty1 [GeV]",2,"ROOT.TLegend(0.58,0.55,0.87,0.95,' ','brNDC')",0,0,True,0,10,"ROOT.TLegend(0.58,0.55,0.8,0.95,' ','brNDC')")

type1_pfMetEt = ("MET E_{T}[GeV]",50,"ROOT.TLegend(0.58,0.55,0.87,0.95,' ','brNDC')",0,0,True,0,10,"ROOT.TLegend(0.58,0.55,0.8,0.95,' ','brNDC')")
...
jetVeto30 = ("Number of P_{T} > 30 GeV Jets",1,"ROOT.TLegend(0.45,0.4,0.87,0.8,' ','brNDC')",0,0,False,0,10,"ROOT.TLegend(0.45,0.4,0.87,0.8,' ','brNDC')")

tDecayMode = ("Tau Decay Mode",1,"ROOT.TLegend(0.45,0.4,0.87,0.8,' ','brNDC')",0,0,False,0,1,"ROOT.TLegend(0.45,0.4,0.87,0.8,' ','brNDC')")
