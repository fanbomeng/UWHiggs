...
def getmtcollMass(row,sys='none'):
        if (sys=='none'):
                ...
                return row.m_t_collinearmass_UnclusteredEnUp_JetEnDown
        elif (sys=='jesup'):
                return row.m_t_collinearmass_UnclusteredEnUp_JetEnUp
        elif (sys=='uesdown'):
                return row.m_t_collinearmass_UnclusteredEnUp_UnclusteredEnDown
        elif (sys=='uesup'):
                return row.m_t_collinearmass_UnclusteredEnUp_UnclusteredEnUp
        elif (sys=='tesup'):
		return row.m_t_collinearmass_UnclusteredEnUp_TauEnUp
	elif (sys=='tesdown'):
		return row.m_t_collinearmass_UnclusteredEnUp_TauEnDown
...
#           return False
      ...
      #     return False
       if row.tMtToPfMet_UnclusteredEnUp > 60:  #was 50   #newcuts65
           return False
    ...
    def boost(self,row):
         ...
         #       return False
          if row.tMtToPfMet_UnclusteredEnUp > 60: #was 35   #newcuts 75
                return False
          if abs(row.tDPhiToPfMet_UnclusteredEnUp)>3.0:
                return False
          if row.bjetCISVVeto30Loose:
...
#	    return False
    ...
    def vbf_gg(self,row):
        ...
        #        return False
        if row.tMtToPfMet_UnclusteredEnUp > 60: #was 35   #newcuts 55
                return False
        if row.jetVeto30<2:  
            return False
	if(row.vbfNJets<2):
