...
class AnalyzeLFVMuTau_progress_TES3_Fakshape_vMoreS_2(MegaBase):
    tree = 'mt/final/Ntuple'
    #tree = 'New_Tree'

    def __init__(self, tree, outfile, **kwargs):
        super(AnalyzeLFVMuTau_progress_TES3_Fakshape_vMoreS_2, self).__init__(tree, outfile, **kwargs)
...
#            print "Sysin value at line 1353*********************************" 
#            if  row.bjetCISVVeto30Medium:
#                   continue
            if not self.obj2_Vlooseiso(row):
                continue
...
#             print "Sysin value at line 1503*********************************" 
             if self.obj1_iso(row):
                 if not self.light:
                    if  fakeset:
 #                      print "Sysin value at line 1508*********************************" 
