...
class AnalyzeLFVMuTauPostBDT_progressuesdown(MegaBase):
    tree = 'mt/final/Ntuple'
    #tree = 'New_Tree'

    def __init__(self, tree, outfile, **kwargs):
        super(AnalyzeLFVMuTauPostBDT_progressuesdown, self).__init__(tree, outfile, **kwargs)
...
#	return True
    ...
    def gg(self,row):
       ...
       if row.tPt < 30:  #was 35   #newcuts30
           return False
       if row.tMtToPfMet_UnclusteredEnDown > 75:  #was 50   #newcuts65
           return False
    ...
    def vbf(self,row):
       ...
       # if row.mPt < 30:
       # 	return False
        if row.tMtToPfMet_UnclusteredEnDown > 75: #was 35   #newcuts 55
                return False
        if row.jetVeto30<2:  
            return False
#	if(row.vbfNJets<2):
...
#            self.var_d_0  ={'mPt_':row.mPt,'tPt_':row.tPt,'mMtToPfMet_type1_':row.mMtToPfMet_UnclusteredEnDown,'tMtToPfMet_type1_':row.tMtToPfMet_UnclusteredEnDown,'m_t_DPhi_':row.m_t_DPhi,'tDPhiToPfMet_type1_':row.tDPhiToPfMet_UnclusteredEnDown,'type1_pfMetEt_':row.type1_pfMet_shiftedPt_UnclusteredEnDown,'jetVeto30_':row.jetVeto30,'vbfMass_':-0.1,'vbfDeta_':-0.1,'deltaeta_m_t_':row.mEta-row.tEta} 
            self.var_d_0  ={'mPt_':row.mPt,'tPt_':row.tPt,'tMtToPfMet_type1_':row.tMtToPfMet_UnclusteredEnDown,'m_t_DPhi_':abs(row.m_t_DPhi),'tDPhiToPfMet_type1_':row.tDPhiToPfMet_UnclusteredEnDown,'type1_pfMetEt_':row.type1_pfMet_shiftedPt_UnclusteredEnDown,'deltaeta_m_t_':abs(row.mEta-row.tEta),'m_t_collinearmass_':row.m_t_collinearmass_UnclusteredEnDown}
            self.var_d_1  =self.var_d_0 
            self.var_d_2  =self.var_d_0
           # self.var_d_2  ={'mPt_':row.mPt,'tPt_':row.tPt,'mMtToPfMet_type1_':row.mMtToPfMet_UnclusteredEnDown,'tMtToPfMet_type1_':row.tMtToPfMet_UnclusteredEnDown,'m_t_DPhi_':row.m_t_DPhi,'tDPhiToPfMet_type1_':row.tDPhiToPfMet_UnclusteredEnDown,'type1_pfMetEt_':row.type1_pfMet_shiftedPt_UnclusteredEnDown,'jetVeto30_':row.jetVeto30,'vbfMass_':row.vbfMass/2600.0,'vbfDeta_':row.vbfDeta/10.0,'deltaeta_m_t_':row.mEta-row.tEta} 
            #self.var_d_2  ={'mMtToPfMet_type1_':row.mMtToPfMet_UnclusteredEnDown,'tMtToPfMet_type1_':row.tMtToPfMet_UnclusteredEnDown,'m_t_DPhi_':row.m_t_DPhi,'tDPhiToPfMet_type1_':row.tDPhiToPfMet_UnclusteredEnDown,'type1_pfMetEt_':row.type1_pfMet_shiftedPt_UnclusteredEnDown,'jetVeto30_':row.jetVeto30,'vbfMass_':row.vbfMass,'vbfDeta_':row.vbfDeta,'deltaeta_m_t_':row.mEta-row.tEta} 
#            if row.jetVeto30==0:
