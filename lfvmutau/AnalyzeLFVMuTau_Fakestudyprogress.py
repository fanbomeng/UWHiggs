...
class AnalyzeLFVMuTau_Fakestudyprogress(MegaBase):
    tree = 'mt/final/Ntuple'
    #tree = 'New_Tree'

    def __init__(self, tree, outfile, **kwargs):
        super(AnalyzeLFVMuTau_Fakestudyprogress, self).__init__(tree, outfile, **kwargs)
...
#            self.book(names[x], "singleIsoTkMu22Pass", "singleIsoTkMu22Pass", 12 ,-0.1,1.1)
           ...
           # self.book(names[x], "nvtx", "Number of vertices", 100, -0.5, 100.5)
            ...
            self.book(names[x], "tJetPartonFlavour", "tJetPartonFlavour", 21,0, 21)
            self.book(names[x], "mJetPartonFlavour", "mJetPartonFlavour", 21,0, 21)
