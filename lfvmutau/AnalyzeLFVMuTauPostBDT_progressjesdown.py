...
class AnalyzeLFVMuTauPostBDT_progressjesdown(MegaBase):
    tree = 'mt/final/Ntuple'
    #tree = 'New_Tree'

    def __init__(self, tree, outfile, **kwargs):
        super(AnalyzeLFVMuTauPostBDT_progressjesdown, self).__init__(tree, outfile, **kwargs)
...
#            self.var_d_0  ={'mPt_':row.mPt,'tPt_':row.tPt,'mMtToPfMet_type1_':row.mMtToPfMet_JetEnDown,'tMtToPfMet_type1_':row.tMtToPfMet_JetEnDown,'m_t_DPhi_':row.m_t_DPhi,'tDPhiToPfMet_type1_':row.tDPhiToPfMet_JetEnDown,'type1_pfMetEt_':row.type1_pfMet_shiftedPt_JetEnDown,'jetVeto30_':row.jetVeto30_JetEnDown,'vbfMass_':-0.1,'vbfDeta_':-0.1,'deltaeta_m_t_':row.mEta-row.tEta} 
            self.var_d_0  ={'mPt_':row.mPt,'tPt_':row.tPt,'tMtToPfMet_type1_':row.tMtToPfMet_JetEnDown,'m_t_DPhi_':abs(row.m_t_DPhi),'tDPhiToPfMet_type1_':row.tDPhiToPfMet_JetEnDown,'type1_pfMetEt_':row.type1_pfMet_shiftedPt_JetEnDown,'deltaeta_m_t_':abs(row.mEta-row.tEta),'m_t_collinearmass_':row.m_t_collinearmass_JetEnDown}
            ...
            #        if MVA0>-0.01: 
             ...
             #       if MVA0>-0.01:
              ...
              #      if MVA0>-0.01:
                    ...
                    #if (row.vbfMass_JetEnDown>550 and abs(row.vbfDeta_JetEnDown)>3.5): 
