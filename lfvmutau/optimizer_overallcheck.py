...
_0jets = {
  ...
  # 'deltaPhi' : [2.95,2.9,2.85,2.8,2.7],
   ...
   'DeltaPhi' : [0.2,0.5,0.9,1.2,1.5,1.8,2.2,2.4,2.6,2.8,3.0],
#   'deltaPhi' : [2.80,2.70],
 #  'mmetdeltaPhi' : [0.0],
   #'tmetdeltaPhi' : [2.6,2.7,2.8,2.9,3.0,3.1],
   'tmetdeltaPhi' : [2.3,2.5,2.7,2.8,2.9,3.0],
   #'deltaPhi' : [3.00,2.8,2.7,2.6,2.5,2.4,2.2,2.0],
  # 'deltaPhi' : [2.1,2.5],
  # 'tMtToPfMet_type1' :[80,35,70]+ range(40,70,10),#was [20,50,10]+[35]
   'tMtToPfMet_type1' :[65,75,85,95,105,115],#was [20,50,10]+[35]
...
#    'tMtToPfMet_type1' :[80,70,60,55,50,45,40,30],
    'tMtToPfMet_type1' :[65,75,85,95,105,115],
...
_2jetsloose = {
   ...
   # 'mPt'  : [25,30,35,45,50,55],
    ...
    'vbfDeta' : [2.0,2.5,3.0,3.5,4.0,4.5],
    #'tPt'  : [33],
    #'mPt'  : [33],
...
_2jetsloose_default = {
    'tPt' : 30,#40
    'mPt' : 25,#40
    'tMtToPfMet_type1' : 95,#was 35
    'vbfMass' : 700.0,#was 200
    'vbfDeta' : 3.5,#was 2.5
}
