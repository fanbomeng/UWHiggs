...
_0jets = {
  ...
  # 'tPt'  : [50],
   'mPt'  : range(30,60,10)+[35,55,60],
  # 'mPt'  : [50,55],
   'deltaPhi' : [3.00,2.5,2.4,2.2],
  # 'deltaPhi' : [2.1,2.5],
   'tMtToPfMet_type1' : range(40,70,10)+[35,70],#was [20,50,10]+[35]
  # 'tMtToPfMet_type1' :[70,75],#was [20,50,10]+[35]
}
_0jets_default = {
   'tPt' : 35,
   'mPt' : 45,     #was 50
   'deltaPhi': 2.7,    #was 2.3
   'tMtToPfMet_type1' :50,  #was 50
}
...
def _get_0jet_regions(tPt, mPt, deltaPhi, tMtToPfMet_type1):
   ...
   return ret
_1jets = {
    'tPt'  : range(35,55,10)+[30,50,55],
  #  'tPt'  : [50],
    'mPt'  : range(30,50,10)+[45,50,55],
  #  'mPt'  : [33],
    'tMtToPfMet_type1' : range(30,50,10)+[45,50,55],
 #   'tMtToPfMet_type1' : [45,50,55],
}
_1jets_default = {
    'tPt' :40,#was 30
    'mPt' : 35,#was 40
    'tMtToPfMet_type1' :35,#was 35
}
...
_2jets = {
    'tPt'  : range(35,55,10)+[50,55],
    'mPt'  : range(35,55,10)+[50,55],
    'tMtToPfMet_type1' : range(30,60,10)+[45],
    'vbfMass' : range(150, 650, 100) + [300,400],
    'vbfDeta' : [2.2,2.7,3.0,3.5, 4.0],
    #'tPt'  : [33],
    #'mPt'  : [33],
