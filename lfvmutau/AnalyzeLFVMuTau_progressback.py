...
#            self.book(names[x], "vbfDphihjnomet","",100,0,4)
    ...
    def TauESC(self,row):
        ...
        if  row.tDecayMode==1:
            self.tau_Pt_C=1.1*row.tPt
        if  row.tDecayMode==10:
            self.tau_Pt_C=1.04*row.tPt
...
#            met = math.sqrt(metpx*metpx+metpy*metpy)
    ...
    def getFakeRateFactorFANBOPt(self,row, fakeset):
         ...
         if fakeset=="def":
            if  row.tDecayMode==0:
                fTauIso=0.244223-0.00121873*(row.tPt-30)
            if  row.tDecayMode==1:
                fTauIso=0.239018-0.000840807*(row.tPt-30)
            if  row.tDecayMode==10:
                fTauIso=0.190481-0.00102621*(row.Pt-30)
         if self.DoTES==1:
            if  row.tDecayMode==0:
