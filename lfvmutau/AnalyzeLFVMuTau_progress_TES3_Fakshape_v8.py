...
class AnalyzeLFVMuTau_progress_TES3_Fakshape_v8(MegaBase):
    tree = 'mt/final/Ntuple'
    #tree = 'New_Tree'

    def __init__(self, tree, outfile, **kwargs):
        super(AnalyzeLFVMuTau_progress_TES3_Fakshape_v8, self).__init__(tree, outfile, **kwargs)
       ...
       #    name=[]
           ...
           for i in sysneed:
               for j in basechannels:
                   names.append(j+i)                    
           JESsys=["Jes_JetAbsoluteFlavMapDown","Jes_JetAbsoluteFlavMapUp","Jes_JetAbsoluteMPFBiasDown","Jes_JetAbsoluteMPFBiasUp","Jes_JetAbsoluteScaleDown","Jes_JetAbsoluteScaleUp","Jes_JetAbsoluteStatDown","Jes_JetAbsoluteStatUp","Jes_JetFlavorQCDDown","Jes_JetFlavorQCDUp","Jes_JetFragmentationDown","Jes_JetFragmentationUp","Jes_JetPileUpDataMCDown","Jes_JetPileUpDataMCUp","Jes_JetPileUpPtBBDown","Jes_JetPileUpPtBBUp","Jes_JetPileUpPtEC1Down","Jes_JetPileUpPtEC1Up","Jes_JetPileUpPtEC2Down","Jes_JetPileUpPtEC2Up","Jes_JetPileUpPtHFDown","Jes_JetPileUpPtHFUp","Jes_JetPileUpPtRefDown","Jes_JetPileUpPtRefUp","Jes_JetRelativeBalDown","Jes_JetRelativeBalUp","Jes_JetRelativeFSRDown","Jes_JetRelativeFSRUp","Jes_JetRelativeJEREC1Down","Jes_JetRelativeJEREC1Up","Jes_JetRelativeJEREC2Down","Jes_JetRelativeJEREC2Up","Jes_JetRelativeJERHFDown","Jes_JetRelativeJERHFUp","Jes_JetRelativePtBBDown","Jes_JetRelativePtBBUp","Jes_JetRelativePtEC1Down","Jes_JetRelativePtEC1Up","Jes_JetRelativePtEC2Down","Jes_JetRelativePtEC2Up","Jes_JetRelativePtHFDown","Jes_JetRelativePtHFUp","Jes_JetRelativeStatECDown","Jes_JetRelativeStatECUp","Jes_JetRelativeStatFSRDown","Jes_JetRelativeStatFSRUp","Jes_JetRelativeStatHFDown","Jes_JetRelativeStatHFUp","Jes_JetSinglePionECALDown","Jes_JetSinglePionECALUp","Jes_JetSinglePionHCALDown","Jes_JetSinglePionHCALUp","Jes_JetTimePtEtaDown","Jes_JetTimePtEtaUp"]
           UESspsys=['chargedUesUp','chargedUesDown','ecalUesUp','ecalUesDown','hcalUesUp','hcalUesDown','hfUesUp','hfUesDown']
           for i in  JESsys:
               for j in basechannels:
                   names.append(j+i)
           for i in  UESspsys:
...
#                 print "comes in as USE111111111111111111"
    ...
    def ZmmEnrich(self,row,m_t_Mass_new,mMtToPfMet_type1_new,type1_pfMetEt_new,tMtToPfMet_type1_new):
        if ((m_t_Mass_new>86 and m_t_Mass_new<96) and mMtToPfMet_type1_new<40 and type1_pfMetEt_new<60 and tMtToPfMet_type1_new<90 and abs(row.mEta-row.tEta)<1.4):
            return True
        return False
...
#            print 'the def tPt %f  and M_coll value %f'  %(self.tau_Pt_C,self.collMass_type1_new)   
            ...
            if self.Sysin:
                 ...
                 baseJESsys=["Jes_JetAbsoluteFlavMapDown","Jes_JetAbsoluteFlavMapUp","Jes_JetAbsoluteMPFBiasDown","Jes_JetAbsoluteMPFBiasUp","Jes_JetAbsoluteScaleDown","Jes_JetAbsoluteScaleUp","Jes_JetAbsoluteStatDown","Jes_JetAbsoluteStatUp","Jes_JetFlavorQCDDown","Jes_JetFlavorQCDUp","Jes_JetFragmentationDown","Jes_JetFragmentationUp","Jes_JetPileUpDataMCDown","Jes_JetPileUpDataMCUp","Jes_JetPileUpPtBBDown","Jes_JetPileUpPtBBUp","Jes_JetPileUpPtEC1Down","Jes_JetPileUpPtEC1Up","Jes_JetPileUpPtEC2Down","Jes_JetPileUpPtEC2Up","Jes_JetPileUpPtHFDown","Jes_JetPileUpPtHFUp","Jes_JetPileUpPtRefDown","Jes_JetPileUpPtRefUp","Jes_JetRelativeBalDown","Jes_JetRelativeBalUp","Jes_JetRelativeFSRDown","Jes_JetRelativeFSRUp","Jes_JetRelativeJEREC1Down","Jes_JetRelativeJEREC1Up","Jes_JetRelativeJEREC2Down","Jes_JetRelativeJEREC2Up","Jes_JetRelativeJERHFDown","Jes_JetRelativeJERHFUp","Jes_JetRelativePtBBDown","Jes_JetRelativePtBBUp","Jes_JetRelativePtEC1Down","Jes_JetRelativePtEC1Up","Jes_JetRelativePtEC2Down","Jes_JetRelativePtEC2Up","Jes_JetRelativePtHFDown","Jes_JetRelativePtHFUp","Jes_JetRelativeStatECDown","Jes_JetRelativeStatECUp","Jes_JetRelativeStatFSRDown","Jes_JetRelativeStatFSRUp","Jes_JetRelativeStatHFDown","Jes_JetRelativeStatHFUp","Jes_JetSinglePionECALDown","Jes_JetSinglePionECALUp","Jes_JetSinglePionHCALDown","Jes_JetSinglePionHCALUp","Jes_JetTimePtEtaDown","Jes_JetTimePtEtaUp"]
                 baseUESsp=['chargedUesUp','chargedUesDown','ecalUesUp','ecalUesDown','hcalUesUp','hcalUesDown','hfUesUp','hfUesDown']
            ...
            if self.Sysin and (not self.is_data):
                 ...
                 for k in baseJESsys:
                     ...
                     if 'Up' in k:
                        ...
                        tmpname='self.DoJES'
                        exec("%s = %d" % (tmpname,2))                  
                     tmpname_3='row.jetVeto30_'+k.split('_Jes_',1)[1]
                     tmpname_5='row.type1_pfMet_shiftedPt_'+k.split('_Jes_',1)[1] 
                     tmpname_6='row.type1_pfMet_shiftedPhi_'+k.split('_Jes_',1)[1] 
                     ...
                     if self.obj2_iso(row) and self.oppositesign(row) and self.obj1_iso(row) and self.kinematics(row): 
                        ...
                        for j in basechannelsI: 
                           if  eval(tmpname_3)==j[0]:
                               tmpname_2='self.'+j[1]+'(row)'
                               if ('vbf_gg' in j[1]):
                                   tmpname_4='row.vbfMass_'+k.split('_Jes_',1)[1]
...
#                     tmpname_3='row.jetVeto30_'+k.split('_CMS_',1)[1]
                     if 'Up' in k:
                         tmpname_5='row.type1_pfMet_shiftedPt_'+k.split('Up',1)[0].upper()+'Up' 
                         tmpname_6='row.type1_pfMet_shiftedPhi_'+k.split('Up',1)[0].upper()+'Up' 
                     if 'Down' in k:
                         tmpname_5='row.type1_pfMet_shiftedPt_'+k.split('Down',1)[0].upper()+'Down' 
                         tmpname_6='row.type1_pfMet_shiftedPhi_'+k.split('Down',1)[0].upper()+'Down' 
                     #print eval(tmpname_6)
                     #print row.type1_pfMet_shiftedPhi_JetEnUp
#                     if k=='_CMS_JetPileUpPtEC1Down':
#                        print "mass collin %s  %f" %(k,self.collMass_type1_new)
