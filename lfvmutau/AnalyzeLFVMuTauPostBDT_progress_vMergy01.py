...
class AnalyzeLFVMuTauPostBDT_progress_vMergy01(MegaBase):
    tree = 'mt/final/Ntuple'
    #tree = 'New_Tree'

    def __init__(self, tree, outfile, **kwargs):
        super(AnalyzeLFVMuTauPostBDT_progress_vMergy01, self).__init__(tree, outfile, **kwargs)
                 ...
                 if not self.light:
                    ...
                    #  self.fill_histos(row,'preselection0Jet')
                      if self.WjetsEnrich(row):
                         ...
                         self.fill_histos(row,'preselectionEnWjets01')
                      if self.ZttEnrich(row,self.m_t_Mass_new,self.tMtToPfMet_type1_new,self.mMtToPfMet_type1_new):
...
#                    self.fill_histos(row,'notIsoNotWeighted',False)
                   ...
                   #   self.fill_histos(row,'notIso0Jet',True)
                      if self.WjetsEnrich(row):
                         ...
                         self.fill_histos(row,'notIsoEnWjets01',True)
                      if self.ZttEnrich(row,self.m_t_Mass_new,self.tMtToPfMet_type1_new,self.mMtToPfMet_type1_new):
...
#                    self.fill_histos(row,'notIsoNotWeighted',False)
                    ...
                    #  self.fill_histos(row,'notIso0JetMT',True,faketype="mtfake")
                      if self.WjetsEnrich(row):
                         ...
                         self.fill_histos(row,'notIsoEnWjets01MT',True,faketype="mtfake")
                      if self.ZttEnrich(row,self.m_t_Mass_new,self.tMtToPfMet_type1_new,self.mMtToPfMet_type1_new):
...
#                    self.fill_histos(row,'notIsoNotWeighted',False)
                    ...
                    #  self.fill_histos(row,'notIso0JetM',True,faketype="muonfake")
                      if self.WjetsEnrich(row):
                         ...
                         self.fill_histos(row,'notIsoEnWjets01M',True,faketype="muonfake")
                      if self.ZttEnrich(row,self.m_t_Mass_new,self.tMtToPfMet_type1_new,self.mMtToPfMet_type1_new):
