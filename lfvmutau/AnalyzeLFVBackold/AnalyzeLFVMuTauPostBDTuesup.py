...
class AnalyzeLFVMuTauPostBDTuesup(MegaBase):
    tree = 'mt/final/Ntuple'
    #tree = 'New_Tree'

    def __init__(self, tree, outfile, **kwargs):
        super(AnalyzeLFVMuTauPostBDTuesup, self).__init__(tree, outfile, **kwargs)
...
#            self.var_d_0  ={'mPt_':row.mPt,'tPt_':row.tPt,'mMtToPfMet_type1_':row.mMtToPfMet_UnclusteredEnUp,'tMtToPfMet_type1_':row.tMtToPfMet_UnclusteredEnUp,'m_t_DPhi_':row.m_t_DPhi,'tDPhiToPfMet_type1_':row.tDPhiToPfMet_UnclusteredEnUp,'type1_pfMetEt_':row.type1_pfMet_shiftedPt_UnclusteredEnUp,'jetVeto30_':row.jetVeto30,'vbfMass_':-0.1,'vbfDeta_':-0.1,'deltaeta_m_t_':row.mEta-row.tEta} 
            self.var_d_0  ={'mMtToPfMet_type1_':row.mMtToPfMet_UnclusteredEnUp,'tMtToPfMet_type1_':row.tMtToPfMet_UnclusteredEnUp,'tDPhiToPfMet_type1_':row.tDPhiToPfMet_UnclusteredEnUp,'lepton_asymmetry_':(row.mPt-row.tPt)/(row.mPt+row.tPt)} 
