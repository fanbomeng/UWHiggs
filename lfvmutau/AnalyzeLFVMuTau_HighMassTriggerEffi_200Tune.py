...
class AnalyzeLFVMuTau_HighMassTriggerEffi_200Tune(MegaBase):
    tree = 'mt/final/Ntuple'

    def __init__(self, tree, outfile, **kwargs):
        super(AnalyzeLFVMuTau_HighMassTriggerEffi_200Tune, self).__init__(tree, outfile, **kwargs)
