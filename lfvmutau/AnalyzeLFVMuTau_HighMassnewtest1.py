...
muon_pog_TriggerIso50_2016B= MuonPOGCorrections.make_muon_pog_IsoMu24oIsoTkMu24_2016ReRecoeffi()
...
class AnalyzeLFVMuTau_HighMassnewtest1(MegaBase):
    tree = 'mt/final/Ntuple'

    def __init__(self, tree, outfile, **kwargs):
        super(AnalyzeLFVMuTau_HighMassnewtest1, self).__init__(tree, outfile, **kwargs)
