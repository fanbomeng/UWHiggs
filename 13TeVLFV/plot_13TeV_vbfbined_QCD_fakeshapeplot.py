...
if shift=="FakesM1stDown":
   fakeMChannels = {"preselection":"notIso","preselectionSS":"notIsoSS","notIso":"notIso","notIsoSS":"notIsoSS","preselection0Jet":"notIso0Jet","preselection1Jet":"notIso1Jet","preselection2Jet":"notIso2Jet","gg":"ggNotIsoM1stDown","boost":"boostNotIsoM1stDown","vbf":"vbfNotIso","vbf_gg":"vbf_ggNotIsoM1stDown","vbf_vbf":"vbf_vbfNotIsoM1stDown"} #map of channels corresponding to selection used for data driven fakes (Region II)  tight tight Isolation with SS
if shift=="FakesM1stUp":
   fakeMChannels = {"preselection":"notIso","preselectionSS":"notIsoSS","notIso":"notIso","notIsoSS":"notIsoSS","preselection0Jet":"notIso0Jet","preselection1Jet":"notIso1Jet","preselection2Jet":"notIso2Jet","gg":"ggNotIsoM1stUp","boost":"boostNotIsoM1stUp","vbf":"vbfNotIso","vbf_gg":"vbf_ggNotIsoM1stUp","vbf_vbf":"vbf_vbfNotIsoM1stUp"} #map of channels corresponding to selection used for data driven fakes (Region II)  tight tight Isolation with SS
if shift=="FakesMT1stDown":
   fakeMTChannels = {"preselection":"notIso","preselectionSS":"notIsoSS","notIso":"notIso","notIsoSS":"notIsoSS","preselection0Jet":"notIso0Jet","preselection1Jet":"notIso1Jet","preselection2Jet":"notIso2Jet","gg":"ggNotIsoMT1stDown","boost":"boostNotIsoMT1stDown","vbf":"vbfNotIso","vbf_gg":"vbf_ggNotIsoMT1stDown","vbf_vbf":"vbf_vbfNotIsoMT1stDown"} #map of channels corresponding to selection used for data driven fakes (Region II)  tight tight Isolation with SS
if shift=="FakesMT1stUp":
   fakeMTChannels = {"preselection":"notIso","preselectionSS":"notIsoSS","notIso":"notIso","notIsoSS":"notIsoSS","preselection0Jet":"notIso0Jet","preselection1Jet":"notIso1Jet","preselection2Jet":"notIso2Jet","gg":"ggNotIsoMT1stUp","boost":"boostNotIsoMT1stUp","vbf":"vbfNotIso","vbf_gg":"vbf_ggNotIsoMT1stUp","vbf_vbf":"vbf_vbfNotIsoMT1stUp"} #map of channels corresponding to selection used for data driven fakes (Region II)  tight tight Isolation with SS
if RUN_OPTIMIZATION==1: 
...
#		shiftStr="_CMS_MET_"+shift #corresponds to name Daniel used in datacards
	...
	elif "FakesM1stDown" in shift:
		shiftStr = "_FakeShapeMuTauM1stDown"
	elif "FakesM1stUp" in shift:
		shiftStr = "_FakeShapeMuTauM1stUp"
	elif "FakesMT1stDown" in shift:
		shiftStr = "_FakeShapeMuTauMT1stDown"
	elif "FakesMT1stUp" in shift:
		shiftStr = "_FakeShapeMuTauMT1stUp"
	else:
		shiftStr="_CMS_MET_"+shift #corresponds to name Daniel used in datacards
...
if (fakeRate == True):
  ...
  wjetsMT.Scale(-1)
  wjets.Add(wjetsMT)
  wjetsdown.Add(wjetsM)


#apply fake rate method
if (fakeRate == True):
  if shift=="Tau":
   fakeChannels = {"preselection":"notIso","preselectionSS":"notIsoSS","notIso":"notIso","notIsoSS":"notIsoSS","preselection0Jet":"notIso0Jet","preselection1Jet":"notIso1Jet","preselection2Jet":"notIso2Jet","gg":"ggNotIso1stUp","boost":"boostNotIso1stUp","vbf":"vbfNotIso","vbf_gg":"vbf_ggNotIso1stUp","vbf_vbf":"vbf_vbfNotIso1stUp"}
  if shift=="Muon":
        fakeMChannels = {"preselection":"notIso","preselectionSS":"notIsoSS","notIso":"notIso","notIsoSS":"notIsoSS","preselection0Jet":"notIso0Jet","preselection1Jet":"notIso1Jet","preselection2Jet":"notIso2Jet","gg":"ggNotIsoM1stUp","boost":"boostNotIsoM1stUp","vbf":"vbfNotIso","vbf_gg":"vbf_ggNotIsoM1stUp","vbf_vbf":"vbf_vbfNotIsoM1stUp"}
  if shift=="MT":
   fakeMTChannels = {"preselection":"notIso","preselectionSS":"notIsoSS","notIso":"notIso","notIsoSS":"notIsoSS","preselection0Jet":"notIso0Jet","preselection
1Jet":"notIso1Jet","preselection2Jet":"notIso2Jet","gg":"ggNotIsoMT1stUp","boost":"boostNotIsoMT1stUp","vbf":"vbfNotIso","vbf_gg":"vbf_ggNotIsoMT1stUp","vbf_v
bf":"vbf_vbfNotIsoMT1stUp"}
  fakechannel = fakeChannels[channel]
  data2016Bfakes = make_histo(savedir,"data_SingleMuon_Run2016B", fakechannel,var,lumidir,lumi,True,)
  data2016Cfakes = make_histo(savedir,"data_SingleMuon_Run2016C", fakechannel,var,lumidir,lumi,True,)
  data2016Dfakes = make_histo(savedir,"data_SingleMuon_Run2016D", fakechannel,var,lumidir,lumi,True,)
  ...
  ttbarfakes = make_histo(savedir,"TT_TuneCUETP8M1_13TeV-powheg-pythia8",fakechannel,var,lumidir,lumi)
  ttbarfakes.Scale(-1)
  wjetsup.Add(zjetsfakes) #avoid double counting  say besides the fakes from DY, and ztautau,ttbar, then the remainning is wjets
  wjetsup.Add(ztautaufakes) #avoid double counting  say besides the fakes from DY, and ztautau,ttbar, then the remainning is wjets
  wjetsup.Add(ttbarfakes) #avoid double counting  say besides the fakes from DY, and ztautau,ttbar, then the remainning is wjets
  ...
  data2016BfakesM.Add(data2016EfakesM)
  data2016BfakesM.Add(data2016FfakesM)
  wjetsMup = data2016BfakesM.Clone()
  zjetsfakesM = make_histo(savedir,"DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",  fakeMchannel,var,lumidir,lumi)
  z1jetsfakesM = make_histo(savedir,"DY1JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",fakeMchannel,var,lumidir,lumi)
  z2jetsfakesM = make_histo(savedir,"DY2JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",fakeMchannel,var,lumidir,lumi)
  z3jetsfakesM = make_histo(savedir,"DY3JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",fakeMchannel,var,lumidir,lumi)
  ...
  ttbarfakesM = make_histo(savedir,"TT_TuneCUETP8M1_13TeV-powheg-pythia8",fakeMchannel,var,lumidir,lumi)
  ttbarfakesM.Scale(-1)
  wjetsup.Add(zjetsfakesM) #avoid double counting  say besides the fakesM from DY, and ztautau,ttbar, then the remainning is wjets
  wjetsup.Add(ztautaufakesM) #avoid double counting  say besides the fakesM from DY, and ztautau,ttbar, then the remainning is wjets
  wjetsup.Add(ttbarfakesM) #avoid double counting  say besides the fakesM from DY, and ztautau,ttbar, then the remainning is wjets
  ...
  data2016BfakesMT.Add(data2016EfakesMT)
  data2016BfakesMT.Add(data2016FfakesMT)
  wjetsMTup = data2016BfakesMT.Clone()
  zjetsfakesMT = make_histo(savedir,"DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",  fakeMTchannel,var,lumidir,lumi)
  z1jetsfakesMT = make_histo(savedir,"DY1JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",fakeMTchannel,var,lumidir,lumi)
  z2jetsfakesMT = make_histo(savedir,"DY2JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",fakeMTchannel,var,lumidir,lumi)
  z3jetsfakesMT = make_histo(savedir,"DY3JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",fakeMTchannel,var,lumidir,lumi)
  ...
  ztautaufakesMT.Add(ztautau4fakesMT)
  ttbarfakesMT = make_histo(savedir,"TT_TuneCUETP8M1_13TeV-powheg-pythia8",fakeMTchannel,var,lumidir,lumi)
  wjetsup.Add(zjetsfakesMT) #avoid double counting  say besides the fakesMT from DY, and ztautau,ttbar, then the remainning is wjets
  wjetsup.Add(ztautaufakesMT) #avoid double counting  say besides the fakesMT from DY, and ztautau,ttbar, then the remainning is wjets
  wjetsup.Add(ttbarfakesMT) #avoid double counting  say besides the fakesMT from DY, and ztautau,ttbar, then the remainning is wjets
  wjetsMTup.Scale(-1)
  wjetsup.Add(wjetsMT)
  wjetsup.Add(wjetsM)
...
if (fakeRate == True):
  ...
  data2016Bfakes.Add(data2016Efakes)
  data2016Bfakes.Add(data2016Ffakes)
  wjetsdown = data2016Bfakes.Clone()
  zjetsfakes = make_histo(savedir,"DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",fakechannel,var,lumidir,lumi)
  z1jetsfakes = make_histo(savedir,"DY1JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",fakechannel,var,lumidir,lumi)
  z2jetsfakes = make_histo(savedir,"DY2JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",fakechannel,var,lumidir,lumi)
  z3jetsfakes = make_histo(savedir,"DY3JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",fakechannel,var,lumidir,lumi)
  ...
  ttbarfakes = make_histo(savedir,"TT_TuneCUETP8M1_13TeV-powheg-pythia8",fakechannel,var,lumidir,lumi)
  ttbarfakes.Scale(-1)
  wjetsdown.Add(zjetsfakes) #avoid double counting  say besides the fakes from DY, and ztautau,ttbar, then the remainning is wjets
  wjetsdown.Add(ztautaufakes) #avoid double counting  say besides the fakes from DY, and ztautau,ttbar, then the remainning is wjets
  wjetsdown.Add(ttbarfakes) #avoid double counting  say besides the fakes from DY, and ztautau,ttbar, then the remainning is wjets
  ...
  data2016BfakesM.Add(data2016EfakesM)
  data2016BfakesM.Add(data2016FfakesM)
  wjetsMdown = data2016BfakesM.Clone()
  zjetsfakesM = make_histo(savedir,"DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",  fakeMchannel,var,lumidir,lumi)
  z1jetsfakesM = make_histo(savedir,"DY1JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",fakeMchannel,var,lumidir,lumi)
  z2jetsfakesM = make_histo(savedir,"DY2JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",fakeMchannel,var,lumidir,lumi)
  z3jetsfakesM = make_histo(savedir,"DY3JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",fakeMchannel,var,lumidir,lumi)
  ...
  ttbarfakesM = make_histo(savedir,"TT_TuneCUETP8M1_13TeV-powheg-pythia8",fakeMchannel,var,lumidir,lumi)
  ttbarfakesM.Scale(-1)
  wjetsdown.Add(zjetsfakesM) #avoid double counting  say besides the fakesM from DY, and ztautau,ttbar, then the remainning is wjets
  wjetsdown.Add(ztautaufakesM) #avoid double counting  say besides the fakesM from DY, and ztautau,ttbar, then the remainning is wjets
  wjetsdown.Add(ttbarfakesM) #avoid double counting  say besides the fakesM from DY, and ztautau,ttbar, then the remainning is wjets
  ...
  data2016BfakesMT.Add(data2016EfakesMT)
  data2016BfakesMT.Add(data2016FfakesMT)
  wjetsMTdown = data2016BfakesMT.Clone()
  zjetsfakesMT = make_histo(savedir,"DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",  fakeMTchannel,var,lumidir,lumi)
  z1jetsfakesMT = make_histo(savedir,"DY1JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",fakeMTchannel,var,lumidir,lumi)
  z2jetsfakesMT = make_histo(savedir,"DY2JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",fakeMTchannel,var,lumidir,lumi)
  z3jetsfakesMT = make_histo(savedir,"DY3JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",fakeMTchannel,var,lumidir,lumi)
  ...
  ztautaufakesMT.Add(ztautau4fakesMT)
  ttbarfakesMT = make_histo(savedir,"TT_TuneCUETP8M1_13TeV-powheg-pythia8",fakeMTchannel,var,lumidir,lumi)
  wjetsdown.Add(zjetsfakesMT) #avoid double counting  say besides the fakesMT from DY, and ztautau,ttbar, then the remainning is wjets
  wjetsdown.Add(ztautaufakesMT) #avoid double counting  say besides the fakesMT from DY, and ztautau,ttbar, then the remainning is wjets
  wjetsdown.Add(ttbarfakesMT) #avoid double counting  say besides the fakesMT from DY, and ztautau,ttbar, then the remainning is wjets
  wjetsMTdown.Scale(-1)
  wjetsdown.Add(wjetsMT)
  wjetsdown.Add(wjetsM)
...
#   wjets.Add(wjetsM)
   wjets.Rebin(binwidth)
   wjetsup.Rebin(binwidth)
   wjetsdown.Rebin(binwidth)
  # wjetsM.Rebin(binwidth)
   #wjetsMT.Rebin(binwidth)
