...
xBins1 = array.array('d',[20,40,60,80,100,200])  # array.array('d',[30,35,40,45,50,55,60,70,80,95,105,140,200,260])  # from the plots Tau
...
#fakeRateData=dataTight.Divide(dataLoose);
