...
def getCategories( channel="et", prefix="" ) :
    ...
    if channel=="me":
        categories[0]="mue_HMuTau_mutaue_1_2016_"+prefix
        categories[1]="mue_HMuTau_mutaue_2_2016_"+prefix
        categories[2]="mue_HMuTau_mutaue_3_2016_"+prefix
        categories[3]="mue_HMuTau_mutaue_4_2016_"+prefix
    return categories
...
def getInfoMap( higgsSF, channel, shift="" ) :
    ...
    infoMap["Diboson"] = [["iboson"+shift],"Diboson","f","#12cadd"]
    ...
    if channel=="em" or channel=="et":
       ...
       infoMap["H125"] = [["LFVGG"+shift,"LFVVBF"+shift,],"H#rightarrow#mu#tau (B=%i%%)"%higgsSF,"l","#ff0000"]
    return infoMap
