...
_0jets = {
  ...
  # 'mPt'  :[25,30,35]+ range(40,60,10)+[55],
   'mPt'  :[120,125,130,135,140,145,150,155,160,165,170,180,185],
  # 'mPt'  : [50,55],
...
#   'tmetdeltaPhi' : [3.0],
  ...
  # 'tMtToPfMet_type1' :[80,35,70]+ range(40,70,10),#was [20,50,10]+[35]
   'tMtToPfMet_type1' :[70,80,90,100,110],#was [20,50,10]+[35]
...
_0jet_region_templates = ['tPt%i', 'mPt%i','tMtToPfMet_type1%i'] #'tPt%i_mPt%i_deltaPhi%.2f_tMtToPfMet_type1%i'
#def _get_0jet_regions(tPt, mPt, DeltaPhi,tmetdeltaPhi, tMtToPfMet_type1):
def _get_0jet_regions(tPt, mPt, tMtToPfMet_type1):
...
#    'tMtToPfMet_type1' :[80,70,60,55,50,45,40,30],
    'tMtToPfMet_type1' :[60,70,80,90,100,110],
...
defaults = [_0jets_default['tPt'], _0jets_default['mPt'],_0jets_default['tMtToPfMet_type1']]
...
cuts0 = [_0jets['tPt'], _0jets['mPt'], _0jets['tMtToPfMet_type1']]
