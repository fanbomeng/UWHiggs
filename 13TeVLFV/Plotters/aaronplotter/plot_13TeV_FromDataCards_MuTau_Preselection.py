...
if fakeRate == True:
	singletFileMap = {"mutau0J":"LFV_preselection0Jet_"+var+"_Fakes_PoissonErrors.root","mutau1J":"LFV_preselection1Jet_"+var+"_Fakes_PoissonErrors.root","mutau2J":"LFV_preselection2Jet_"+var+"_Fakes_PoissonErrors.root","preselmutau":"LFV_preselection_"+var+"_Fakes_PoissonErrors.root","ssmutau":"LFV_preselectionSS_"+var+"_Fakes_PoissonErrors.root","notIsomutau":"LFV_notIso_"+var+"_Fakes_PoissonErrors.root","ssnotIsomutau":"LFV_notIsoSS_"+var+"_Fakes_PoissonErrors.root","nvtxmutau":"LFV_preselection_nvtx_Fakes_PoissonErrors.root"}
else:
	singletFileMap = {"mutau0J":"LFV_preselection0Jet_"+var+"__PoissonErrors.root","mutau1J":"LFV_preselection1Jet_"+var+"__PoissonErrors.root","mutau2J":"LFV_preselection2Jet_"+var+"__PoissonErrors.root","preselmutau":"LFV_preselection_"+var+"__PoissonErrors.root","ssmutau":"LFV_preselectionSS_"+var+"__PoissonErrors.root","notIsomutau":"LFV_notIso_"+var+"__PoissonErrors.root","ssnotIsomutau":"LFV_notIsoSS_"+var+"__PoissonErrors.root","nvtxmutau":"LFV_preselection_nvtx__PoissonErrors.root"}
