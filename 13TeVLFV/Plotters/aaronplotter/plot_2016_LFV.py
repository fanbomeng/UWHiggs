...
def make_histo(savedir,file_str, channel,var,lumidir,lumi,isData=False,): #get histogram from file, properly weight histogram
		...
		file_str = file_str.replace("JetsToTauTau","JetsToLL")
                metafile = lumidir + file_str+"_weight.log"
        	f = open(metafile).read().splitlines()
                nevents = float((f[0]).split(': ',1)[-1])
                xsec = eval("XSec_2016."+file_str.replace("-","_"))
...
ztautau1 = make_histo(savedir,"DY1JetsToTauTau_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channel,var,lumidir,lumi)
ztautau2 = make_histo(savedir,"DY2JetsToTauTau_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channel,var,lumidir,lumi)
ztautau3 = make_histo(savedir,"DY3JetsToTauTau_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channel,var,lumidir,lumi)
ztautau4 = make_histo(savedir,"DY4JetsToTauTau_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channel,var,lumidir,lumi)
ztautau = make_histo(savedir,"DYJetsToTauTau_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channel,var,lumidir,lumi)
...
if (fakeRate == True):
  ...
  wjets.Add(data2016Cfakes)
  wjets.Add(data2016Dfakes)
  ...
  zjetsfakes = zjetsfakes1.Clone()
  zjetsfakes.Add(zjetsfakes2)
  zjetsfakes.Add(zjetsfakes3)
  zjetsfakes.Add(zjetsfakes4)
  zjetsfakes.Scale(-1)
  #zjetsfakes.Scale(0.83)
  ztautaufakes1 = make_histo(savedir,"DY1JetsToTauTau_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",fakechannel,var,lumidir,lumi)
  ztautaufakes2 = make_histo(savedir,"DY2JetsToTauTau_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",fakechannel,var,lumidir,lumi)
  ztautaufakes3 = make_histo(savedir,"DY3JetsToTauTau_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",fakechannel,var,lumidir,lumi)
  ztautaufakes4 = make_histo(savedir,"DY4JetsToTauTau_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",fakechannel,var,lumidir,lumi)
  ztautaufakes = ztautaufakes1.Clone()
  ztautaufakes.Add(ztautaufakes2)
  ztautaufakes.Add(ztautaufakes3)
  ztautaufakes.Add(ztautaufakes4)
  ztautaufakes.Scale(-1)
  #ztautaufakes.Scale(0.83)
  ...
  ttbarfakes.Scale(-1)
  #ttbarfakes.Scale(0.83)
  ttbar.Add(ttbarfakes) #avoid double counting
  wjets.Add(zjetsfakes) #avoid double counting
elif fakeRate==False:
  wjets1 = make_histo(savedir,"W1JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channel,var,lumidir,lumi)
  wjets2 = make_histo(savedir,"W2JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channel,var,lumidir,lumi)
  wjets3 = make_histo(savedir,"W3JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channel,var,lumidir,lumi)
  wjets4 = make_histo(savedir,"W4JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channel,var,lumidir,lumi)
...
if ("collMass" in var or "m_t_Mass" in var):
  ...
  binHigh = data.FindBin(150)
if blinded == True:
        for i in range(binLow,binHigh):
		data.SetBinContent(i,-1000)
...
#fill empty bins
#if fakeRate == False:
#	do_binbybin(wjets,"WJets_2016",lowDataBin,highDataBin)
#do_binbybin(ztautau,"ZTauTauJetsToLL_2016",lowDataBin,highDataBin)
#do_binbybin(zjets,"DYJetsToLL_2016",lowDataBin,highDataBin)
#do_binbybin(diboson,"Diboson_2016",lowDataBin,highDataBin)
...
#do_binbybin(singlet,"SingleTop_2016",lowDataBin,highDataBin)
...
print lumi
latexStr = "%.3f fb^{-1} (13 TeV)"%(lumi/1000)
