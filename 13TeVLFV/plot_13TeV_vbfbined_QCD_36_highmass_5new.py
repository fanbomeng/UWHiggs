...
if (highMass and 'collMass_type1' in var and 'boost' in channel) or Ifrebin:
   if MasspointNum==200:
        ...
        binwidth =array.array('d',[0,15,30,45,60,75,90,105,120,135,150,165,180,195,210,230,250,270,300,330,360,390,425,460,500,540,630,710,810,900,1000,1200,1400])
...
# this is ingeneral, if no bin above is spacified, then used this one, which actually is the 200GeV binning
        ...
        binwidth =array.array('d',[0,15,30,45,60,75,90,105,120,135,150,165,180,195,210,230,250,270,300,330,360,390,425,460,500,540,580,630,690,750,810,900,1000,1200,1400])
elif highMass and ('tPt' in var or 'mPt' in var):
        binwidth =array.array('d',[0,15,30,45,60,80,105,135,165,195,250,300,400,500])
elif highMass and ('collMass_type1' in var and "selectionSS450" in channel):
        binwidth =array.array('d',[0,75,150,220,300,400,500,600,750,900,1400])
elif highMass and ('collMass_type1' in var and "selectionSS200" in channel):
        binwidth =array.array('d',[0,30,60,100,150,200,250,300,375,450,525,630,750,900,1200,1400])
elif highMass and ('collMass_type1' in var and "EnWjets" in channel):
        #binwidth =array.array('d',[0,30,60,100,150,200,250,300,375,450,525,630,750,1000,1400])
        binwidth =array.array('d',[0,60,150,250,350,500,650,800,1000,1400])
elif highMass and ('mMtToPfMet_type1' in var and "EnWjets" in channel):
        binwidth =array.array('d',[0,15,30,45,60,75,90,105,120,135,150,165,180,195,210,230,250,270,300,330,360,390,425,460,500,540,580,630,690,750,810,900,1000,1200,1400])
else:
        binwidth =array.array('d',[0,15,30,45,60,75,90,105,120,135,150,165,180,195,210,230,250,270,300,330,360,390,425,460,500,540,580,630,690,750,810,900,1000,1200,1400])
...
#   do_binbybinQCD(wjetsM,lowDataBin,highDataBin)
   print 'the number of fake muons  %f and the ratio %f '  %(wjetsM.Integral(),wjetsM.Integral()/(wjetsM.Integral()+wjets.Integral()))
