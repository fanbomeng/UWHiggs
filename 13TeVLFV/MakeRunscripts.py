...
f = open('Run_BDT_rename.sh', 'w')
for i in tmptotal_1:
    for j in base:
        f.write('python plot_13TeV_vbfbined_QCD_36_v3.py LFV_BDT/AnalyzeLFVMuTauPostBDT_progress/ BDTcuts '+j+ '    0  '+i+'    tPt0   0'  '\n')

f.close()

g = open('Run_BDT_rename_2.sh', 'w')
tmptotal_2=sysneed_II
for i in tmptotal_2:
    for j in base:
        g.write('python plot_13TeV_vbfbined_QCD_36_v3.py LFV_BDT/AnalyzeLFVMuTauPostBDT_progress/ BDTcuts '+j+ '    0  '+i+'    tPt0   0'  '\n')
