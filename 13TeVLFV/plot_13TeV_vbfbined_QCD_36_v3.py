...
if (not fakeallplot) and fakeRate:
   wjetsMT.Scale(-1)
   print "check the MT fakes %f" %wjetsMT.Integral()
   print "check the M fakes %f" %wjetsM.Integral()
   print "check the Tau fakes %f" %wjets.Integral()
   #wjetsM.Scale(-1)
   wjetsM.Add(wjetsMT)
   do_binbybinQCD(wjetsM,lowDataBin,highDataBin)
   wjets.Add(wjetsM)
   print "check the total fakes %f" %wjets.Integral()
   ##################wjets.Add(wjetsM)
  # wjets=wjetsM
  # wjets.Add(wjetsMT)
   if 'BDT' in var:
