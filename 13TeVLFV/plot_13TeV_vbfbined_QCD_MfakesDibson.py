...
#  do_binbybinQCD(smhggQCDs,lowDataBin,highDataBin)
  ...
  wwQCDs = make_histo(savedir,"WWTo2L2Nu_13TeV-powheg",QCDChannel,var,lumidir,lumi)
#  do_binbybinQCD(wwQCDs,lowDataBin,highDataBin)
  ...
  wzQCDs = make_histo(savedir,"WZTo3LNu_TuneCUETP8M1_13TeV-powheg-pythia8",QCDChannel,var,lumidir,lumi)
#  do_binbybinQCD(wzQCDs,lowDataBin,highDataBin)
  ...
  zzQCDs = make_histo(savedir,"ZZTo4L_13TeV_powheg_pythia8",QCDChannel,var,lumidir,lumi)
...
ww = make_histo(savedir,"WWTo2L2Nu_13TeV-powheg",channel,var,lumidir,lumi)
wz = make_histo(savedir,"WZTo3LNu_TuneCUETP8M1_13TeV-powheg-pythia8",channel,var,lumidir,lumi)
zz = make_histo(savedir,"ZZTo4L_13TeV_powheg_pythia8",channel,var,lumidir,lumi)
