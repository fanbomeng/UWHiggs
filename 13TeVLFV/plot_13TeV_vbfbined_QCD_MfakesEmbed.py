...
if EmbedZtautau:
   ZtautauEmbed=make_histo(savedir,"EmbeddingRun2016B", channel,var,lumidir,1) 
   ZtautauEmbedC=make_histo(savedir,"EmbeddingRun2016C", channel,var,lumidir,1) 
   ZtautauEmbedD=make_histo(savedir,"EmbeddingRun2016D", channel,var,lumidir,1) 
   ZtautauEmbedE=make_histo(savedir,"EmbeddingRun2016E", channel,var,lumidir,1) 
   ZtautauEmbedF=make_histo(savedir,"EmbeddingRun2016F", channel,var,lumidir,1) 
   ZtautauEmbedG=make_histo(savedir,"EmbeddingRun2016G", channel,var,lumidir,1) 
   ZtautauEmbed.Add(ZtautauEmbedC)
   ZtautauEmbed.Add(ZtautauEmbedD)
   ZtautauEmbed.Add(ZtautauEmbedE)
   ZtautauEmbed.Add(ZtautauEmbedF)
   ZtautauEmbed.Add(ZtautauEmbedG)
lowDataBin =1 
...
#  do_binbybinQCD(ztautau4fakes,lowDataBin,highDataBin)
  ...
  if EmbedZtautau:
   ZtautauEmbedfakes=make_histo(savedir,"EmbeddingRun2016B",fakechannel,var,lumidir,1) 
   ZtautauEmbedfakesC=make_histo(savedir,"EmbeddingRun2016C",fakechannel,var,lumidir,1) 
   ZtautauEmbedfakesD=make_histo(savedir,"EmbeddingRun2016D",fakechannel,var,lumidir,1) 
   ZtautauEmbedfakesE=make_histo(savedir,"EmbeddingRun2016E",fakechannel,var,lumidir,1) 
   ZtautauEmbedfakesF=make_histo(savedir,"EmbeddingRun2016F",fakechannel,var,lumidir,1) 
   ZtautauEmbedfakesG=make_histo(savedir,"EmbeddingRun2016G",fakechannel,var,lumidir,1) 
   ZtautauEmbedfakes.Add(ZtautauEmbedfakesC)
   ZtautauEmbedfakes.Add(ZtautauEmbedfakesD)
   ZtautauEmbedfakes.Add(ZtautauEmbedfakesE)
   ZtautauEmbedfakes.Add(ZtautauEmbedfakesF)
   ZtautauEmbedfakes.Add(ZtautauEmbedfakesG)
   ZtautauEmbedfakes.Scale(-1)
   ZtautauEmbed.Add(ZtautauEmbedfakes)  
...
#  do_binbybinQCD(ztautau4fakesM,lowDataBin,highDataBin)
  ...
  if EmbedZtautau:
   ZtautauEmbedfakesM=make_histo(savedir,"EmbeddingRun2016B",fakeMchannel,var,lumidir,1) 
   ZtautauEmbedCfakesM=make_histo(savedir,"EmbeddingRun2016C",fakeMchannel,var,lumidir,1) 
   ZtautauEmbedDfakesM=make_histo(savedir,"EmbeddingRun2016D",fakeMchannel,var,lumidir,1) 
   ZtautauEmbedEfakesM=make_histo(savedir,"EmbeddingRun2016E",fakeMchannel,var,lumidir,1) 
   ZtautauEmbedFfakesM=make_histo(savedir,"EmbeddingRun2016F",fakeMchannel,var,lumidir,1) 
   ZtautauEmbedGfakesM=make_histo(savedir,"EmbeddingRun2016G",fakeMchannel,var,lumidir,1) 
   ZtautauEmbedfakesM.Add(ZtautauEmbedCfakesM)
   ZtautauEmbedfakesM.Add(ZtautauEmbedDfakesM)
   ZtautauEmbedfakesM.Add(ZtautauEmbedEfakesM)
   ZtautauEmbedfakesM.Add(ZtautauEmbedFfakesM)
   ZtautauEmbedfakesM.Add(ZtautauEmbedGfakesM)
   ZtautauEmbedfakesM.Scale(-1)
 #  ZtautauEmbed.Add(ZtautauEmbedfakesM)  
...
#  do_binbybinQCD(ztautau4fakesMT,lowDataBin,highDataBin)
 ...
 # ztautaufakesMT.Scale(-1)
  ...
  if EmbedZtautau:
   ZtautauEmbedfakesMT=make_histo(savedir,"EmbeddingRun2016B",fakeMTchannel,var,lumidir,1) 
   ZtautauEmbedCfakesMT=make_histo(savedir,"EmbeddingRun2016C",fakeMTchannel,var,lumidir,1) 
   ZtautauEmbedDfakesMT=make_histo(savedir,"EmbeddingRun2016D",fakeMTchannel,var,lumidir,1) 
   ZtautauEmbedEfakesMT=make_histo(savedir,"EmbeddingRun2016E",fakeMTchannel,var,lumidir,1) 
   ZtautauEmbedFfakesMT=make_histo(savedir,"EmbeddingRun2016F",fakeMTchannel,var,lumidir,1) 
   ZtautauEmbedGfakesMT=make_histo(savedir,"EmbeddingRun2016G",fakeMTchannel,var,lumidir,1) 
   ZtautauEmbedfakesMT.Add(ZtautauEmbedCfakesMT)
   ZtautauEmbedfakesMT.Add(ZtautauEmbedDfakesMT)
   ZtautauEmbedfakesMT.Add(ZtautauEmbedEfakesMT)
   ZtautauEmbedfakesMT.Add(ZtautauEmbedFfakesMT)
   ZtautauEmbedfakesMT.Add(ZtautauEmbedGfakesMT)
#   ZtautauEmbed.Add(ZtautauEmbedfakesMT)  
...
#  ttbarfakesMT = make_histo(savedir,"TT_TuneCUETP8M1_13TeV-powheg-pythia8-evtgen",fakechannel,var,lumidir,lumi)
 ...
 # wjets.Add(zjetsfakesMT) #avoid double counting  say besides the fakesMT from DY, and ztautau,ttbar, then the remainning is wjets
  ...
  if EmbedZtautau:
    ZtautauEmbed.Scale(ztautau.Integral()/ZtautauEmbed.Integral())
    ztautau=ZtautauEmbed
