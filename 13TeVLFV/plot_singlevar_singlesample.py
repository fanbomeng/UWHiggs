...
#          if i==0:
 ...
 #  histlist[0].Rebin(binwidth)
   ...
   legend.AddEntry(histlist[0],sampleused)
   #norm=gghmutau125_0.GetEntries()
   #gghmutau125_0.Scale(1.00/norm);
   histlist[0].SetTitle("")
   histlist[0].GetXaxis().SetTitle(xlabel)
   histlist[0].GetXaxis().SetNdivisions(510)
   histlist[0].GetXaxis().SetLabelSize(0.035)
   histlist[0].GetXaxis().SetRangeUser(0,xRange)
   histlist[0].GetYaxis().SetTitle(ylabel)
   histlist[0].GetYaxis().SetTitleOffset(1.40)
