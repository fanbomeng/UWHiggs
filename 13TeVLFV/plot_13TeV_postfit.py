...
if "mue" in rootdir:
	wjets = get_histos(savedir,mlfitMap[rootdir],dirMap[rootdir],"wjets",postfit)
...
if "mutauhad_0" in rootdir:
        catString = "#mu#tau_{h} 0-Jet"
if "mutauhad_1" in rootdir:
        catString = "#mu#tau_{h} 1-Jet"
if "mutauhad_2" in rootdir:
        catString = "#mu#tau_{h} 2-Jet loose"
if "mutauhad_3" in rootdir:
        catString = "#mu#tau_{h} 2-Jet tight"
