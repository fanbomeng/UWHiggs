...
eetLoose1 = make_histo2(savedir2,"DY1JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channelLoose,var2)
eetLoose2 = make_histo2(savedir2,"DY2JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channelLoose,var2)
eetLoose3 = make_histo2(savedir2,"DY3JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channelLoose,var2)
eetLoose4 = make_histo2(savedir2,"DY4JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channelLoose,var2)
eetLoose =   make_histo2(savedir2,"DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channelLoose,var2)
...
eetLoosevv =        make_histo2(savedir2,"VVTo2L2Nu_13TeV_amcatnloFXFX_madspin_pythia8",channelLoose,var2)
eetLooseww =        make_histo2(savedir2,"WWTo1L1Nu2Q_13TeV_amcatnloFXFX_madspin_pythia8",channelLoose,var2)
eetLoosewzjlllnu =  make_histo2(savedir2,"WZJToLLLNu_TuneCUETP8M1_13TeV-amcnlo-pythia8",channelLoose,var2)
eetLoosewz1l1nu2q = make_histo2(savedir2,"WZTo1L1Nu2Q_13TeV_amcatnloFXFX_madspin_pythia8",channelLoose,var2)
eetLoosewz1l3nu =   make_histo2(savedir2,"WZTo1L3Nu_13TeV_amcatnloFXFX_madspin_pythia8",channelLoose,var2)
eetLoosewz2l2q =    make_histo2(savedir2,"WZTo2L2Q_13TeV_amcatnloFXFX_madspin_pythia8",channelLoose,var2)
eetLoosezz4l =      make_histo2(savedir2,"ZZTo4L_13TeV-amcatnloFXFX-pythia8",channelLoose,var2)
eetLoosezz2l2q =    make_histo2(savedir2,"ZZTo2L2Q_13TeV_amcatnloFXFX_madspin_pythia8",channelLoose,var2)
...
eetTight1 = make_histo2(savedir2,"DY1JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channelTight,var2)
eetTight2 = make_histo2(savedir2,"DY2JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channelTight,var2)
eetTight3 = make_histo2(savedir2,"DY3JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channelTight,var2)
eetTight4 = make_histo2(savedir2,"DY4JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channelTight,var2)
eetTight =  make_histo2(savedir2,"DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channelTight,var2)
...
eetTightvv =        make_histo2(savedir2,"VVTo2L2Nu_13TeV_amcatnloFXFX_madspin_pythia8",channelTight,var2)
eetTightww =        make_histo2(savedir2,"WWTo1L1Nu2Q_13TeV_amcatnloFXFX_madspin_pythia8",channelTight,var2)
eetTightwzjlllnu =  make_histo2(savedir2,"WZJToLLLNu_TuneCUETP8M1_13TeV-amcnlo-pythia8",channelTight,var2)
eetTightwz1l1nu2q = make_histo2(savedir2,"WZTo1L1Nu2Q_13TeV_amcatnloFXFX_madspin_pythia8",channelTight,var2)
eetTightwz1l3nu =   make_histo2(savedir2,"WZTo1L3Nu_13TeV_amcatnloFXFX_madspin_pythia8",channelTight,var2)
eetTightwz2l2q =    make_histo2(savedir2,"WZTo2L2Q_13TeV_amcatnloFXFX_madspin_pythia8",channelTight,var2)
eetTightzz4l =      make_histo2(savedir2,"ZZTo4L_13TeV-amcatnloFXFX-pythia8",channelTight,var2)
eetTightzz2l2q =    make_histo2(savedir2,"ZZTo2L2Q_13TeV_amcatnloFXFX_madspin_pythia8",channelTight,var2)
...
dataLooseeet =  make_histo2(savedir2,"data_SingleElectron_Run2016B",channelLoose,var2,True)
dataLooseeetC = make_histo2(savedir2,"data_SingleElectron_Run2016C",channelLoose,var2,True)
dataLooseeetD = make_histo2(savedir2,"data_SingleElectron_Run2016D",channelLoose,var2,True)
dataLooseeetE = make_histo2(savedir2,"data_SingleElectron_Run2016E",channelLoose,var2,True)
dataLooseeetF = make_histo2(savedir2,"data_SingleElectron_Run2016F",channelLoose,var2,True)
dataLooseeetG = make_histo2(savedir2,"data_SingleElectron_Run2016G",channelLoose,var2,True)
dataLooseeetH = make_histo2(savedir2,"data_SingleElectron_Run2016H",channelLoose,var2,True)
...
print 'check  number of Loose eee here %f'  %dataLooseeet.Integral()
dataLooseeet.Add(eetLooseww)
dataLoosemmt.Add(mmtLooseww)
#do_binbybinQCD(dataLoosemmt)

print 'check  number of Loose eee2 here %f'  %dataLooseeet.Integral()
...
dataTighteet =  make_histo2(savedir2,"data_SingleElectron_Run2016B",channelTight,var2,True)
dataTighteetC = make_histo2(savedir2,"data_SingleElectron_Run2016C",channelTight,var2,True)
dataTighteetD = make_histo2(savedir2,"data_SingleElectron_Run2016D",channelTight,var2,True)
dataTighteetE = make_histo2(savedir2,"data_SingleElectron_Run2016E",channelTight,var2,True)
dataTighteetF = make_histo2(savedir2,"data_SingleElectron_Run2016F",channelTight,var2,True)
dataTighteetG = make_histo2(savedir2,"data_SingleElectron_Run2016G",channelTight,var2,True)
dataTighteetH = make_histo2(savedir2,"data_SingleElectron_Run2016H",channelTight,var2,True)
...
print 'check  number of tight eee here %f'  %dataTighteet.Integral()
dataTighteet.Add(eetTightww)

print 'check  number of tight eee2 here %f'  %dataTighteet.Integral()
#print 'check  number of tight eee here %f'  %dataTighteet.Integral()
...
xBins1 = array.array('d',[30,35,40,45,50,55,60,70,80,90,100,120,140,160,180,200,300])  # from the plots Tau
if not onebin:
  #xBins1 = array.array('d',[30,35,40,45,50,55,60,70,80,95,140,200,600])  # from the plots Tau
  xBins1 = array.array('d',[20,40,60,80,100,200,300])  # from the plots Tau
  ...
  if 'Decay10' in channelTight:
      ...
      #xBins1 = array.array('d',[30,35,40,45,50,55,60,70,80,90,200,600])  # from the plots Tau
      xBins1 = array.array('d',[30,90,200,600])  # from the plots Tau
      #xBins1 = array.array('d',[30,260])  # from the plots Tau
#else:
...
for ibin in range(0,dataTightmmt.GetXaxis().GetNbins()+1):
        if dataLoosemmt.GetBinContent(ibin):
   	   print 'MMEData bin content tight and loose bin center, ratio', dataTightmmt.GetBinContent(ibin), dataLoosemmt.GetBinContent(ibin),dataLoosemmt.GetBinCenter(ibin),(dataTightmmt.GetBinContent(ibin)/dataLoosemmt.GetBinContent(ibin))

checkelectron=ROOT.TEfficiency(dataTighteet,dataLooseeet);


for ibin in range(0,dataTighteet.GetXaxis().GetNbins()+1):
        if dataLooseeet.GetBinContent(ibin):
   	   print 'EEEData addin bin content tight and loose bin center, ratio', dataTighteet.GetBinContent(ibin), dataLooseeet.GetBinContent(ibin),dataLooseeet.GetBinCenter(ibin),(dataTighteet.GetBinContent(ibin)/dataLooseeet.GetBinContent(ibin))
...
for ibin in range(0,dataTightmmt.GetXaxis().GetNbins()+1):
        if dataLoosemmt.GetBinContent(ibin):
   	   print 'EEEData bin content tight and loose bin center, ratio', dataTightmmt.GetBinContent(ibin), dataLoosemmt.GetBinContent(ibin),dataLoosemmt.GetBinCenter(ibin),(dataTightmmt.GetBinContent(ibin)/dataLoosemmt.GetBinContent(ibin))
...
if ('e3Pt' in var2):
   #fakeRate1.GetXaxis().SetRangeUser(30,600)
   #fakeRateData1.GetXaxis().SetRangeUser(30,600)
   fakeRate1.GetXaxis().SetRangeUser(20,300)
   fakeRateData1.GetXaxis().SetRangeUser(20,300)
   if 'VBF' in channelTight:
...
#fakeFit = ROOT.TF1("adsf","[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x",40,200)
  ...
  if not 'VBF' in channelTight:
     fakeFit1 = ROOT.TF1("adsf","[0]+[1]*(x-30)",30,600)
