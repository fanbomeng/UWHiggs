...
fh = open('weightNormal_MORE_Sold.py','a')
for sample in samplelist:
       if ('data' not in sample): #calculate effective luminosity
           ...
           xsec = eval("XSecnew1."+sample.replace("-","_"))
        ...
        #   weight=lumi/efflumi
           if ("1Jets" in sample ):
              ...
              xsec1 = eval("XSecnew1."+Inclusivefilenambe.replace("-","_"))
