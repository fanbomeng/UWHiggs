...
for directory in inputdir:
   for region in optimizer_new.regions["0"]:
      subprocess.call(["hadd",directory+"subgg"+region+".root",directory+"LFV_boost_collMass_type1__"+sysname[i]+"Lumi30000.0_Blinded_PoissonErrors.root",directory+"LFV_vbf_vbf_collMass_type1__"+sysname[i]+"Lumi30000.0_Blinded_PoissonErrors.root",directory+"LFV_vbf_gg_collMass_type1__"+sysname[i]+"Lumi30000.0_Blinded_PoissonErrors.root",directory+"LFV_gg"+region+"_collMass_type1__"+sysname[i]+"Lumi30000.0_Blinded_PoissonErrors.root"])	
   ...
   for region in optimizer_new.regions["2loose"]:
      subprocess.call(["hadd",directory+"subvbf_gg"+region+".root",directory+"LFV_boost_collMass_type1__"+sysname[i]+"Lumi30000.0_Blinded_PoissonErrors.root",directory+"LFV_vbf_gg"+region+"_collMass_type1__"+sysname[i]+"Lumi30000.0_Blinded_PoissonErrors.root",directory+"LFV_vbf_vbf_collMass_type1__"+sysname[i]+"Lumi30000.0_Blinded_PoissonErrors.root",directory+"LFV_gg_collMass_type1__"+sysname[i]+"Lumi30000.0_Blinded_PoissonErrors.root"])	
   for region in optimizer_new.regions["2tight"]:
      subprocess.call(["hadd",directory+"subvbf_vbf"+region+".root",directory+"LFV_boost_collMass_type1__"+sysname[i]+"Lumi30000.0_Blinded_PoissonErrors.root",directory+"LFV_vbf_vbf"+region+"_collMass_type1__"+sysname[i]+"Lumi30000.0_Blinded_PoissonErrors.root",directory+"LFV_vbf_gg_collMass_type1__"+sysname[i]+"Lumi30000.0_Blinded_PoissonErrors.root",directory+"LFV_gg_collMass_type1__"+sysname[i]+"Lumi30000.0_Blinded_PoissonErrors.root"])	
