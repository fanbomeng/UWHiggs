...
_0jets = {
  ...
  # 'tPt'  : [50],
   'mPt'  : range(30,60,10)+[25,35,55],
  # 'mPt'  : [50,55],
   'deltaPhi' : [3.00,2.5,2.4,2.2,2.0],
  # 'deltaPhi' : [2.1,2.5],
   'tMtToPfMet_type1' : range(40,70,10)+[35,70,80],#was [20,50,10]+[35]
...
_1jets = {
  ...
  #  'tPt'  : [50],
    'mPt'  : range(30,50,10)+[25,45,50,55],
  #  'mPt'  : [33],
    'tMtToPfMet_type1' : range(30,50,10)+[45,50,55,60,70,80],
...
_2jets = {
    'tPt'  : range(35,55,10)+[30,50,55],
    'mPt'  : range(35,55,10)+[25,30,50,55],
    'tMtToPfMet_type1' : range(30,60,10)+[45,60,70,80],
    'vbfMass' : range(150, 650, 100) + [100,300,400],
