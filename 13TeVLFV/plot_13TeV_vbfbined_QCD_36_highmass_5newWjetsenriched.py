...
def do_binbybinQCD(histo,lowBound,highBound): # This is first to used check QCDs events for data driven method, if there are empty bins, then set it to be zer
         return  1
#        if clearnoverflow: 
...
if RUN_OPTIMIZATION==1:
   ...
   fakeChannels = {"preselection":"notIso","preselectionSS":"notIsoSS","selectionSS200":"selectionnotIsoSS200","selectionSS450":"selectionnotIsoSS450","IsoSS0Jet":"notIsoSS0Jet","IsoSS1Jet":"notIsoSS1Jet",'preslectionEnWjets':'notIsoEnWjets','preslectionEnWjets2':'notIsoEnWjets2','preslectionEnWjets3':'notIsoEnWjets3','preslectionEnWjets0Jet':'notIsoEnWjets0Jet','preslectionEnWjets1Jet':'notIsoEnWjets1Jet','preslectionEnZtt':'notIsoEnZtt','preslectionEnZtt0Jet':'notIsoEnZtt0Jet','preslectionEnZtt1Jet':'notIsoEnZtt1Jet','preslectionEnZmm':'notIsoEnZmm','preslectionEnZmm0Jet':'notIsoEnZmm0Jet','preslectionEnZmm1Jet':'notIsoEnZmm1Jet',"notIso":"notIso","notIsoSS":"notIsoSS","preselection0Jet":"notIso0Jet","preselection1Jet":"notIso1Jet","gg":"ggNotIso","gg125":"ggNotIso125","gg200":"ggNotIso200","gg300":"ggNotIso300","gg450":"ggNotIso450","gg600":"ggNotIso600","gg750":"ggNotIso750","gg900":"ggNotIso900","boost":"boostNotIso","boost125":"boostNotIso125","boost200":"boostNotIso200","boost300":"boostNotIso300","boost450":"boostNotIso450","boost600":"boostNotIso600","boost750":"boostNotIso750","boost900":"boostNotIso900","vbf":"vbfNotIso","vbf_gg":"vbf_ggNotIso","vbf_vbf":"vbf_vbfNotIso",'preslectionEnTTbar':'notIsoEnTTbar','preslectionEnTTbar0Jet':'notIsoEnTTbar0Jet','preslectionEnTTbar1Jet':'notIsoEnTTbar1Jet'}
...
if RUN_OPTIMIZATION==1: 
   ...
   #QCDChannels={"preselection0Jet":"IsoSS0Jet/","preselection":"preselectionSS/","preselectionSS":"notIsoSS/","selectionSS200":"selectionnotIsoSS200/","selectionSS450":"selectionnotIsoSS450/",'boost200':'selectionboostSS200/','boost450':'selectionboostSS450/','gg200':'selectionggSS200/','gg450':'selectionggSS450/',"preselection1Jet":"IsoSS1Jet","preselection2Jet":"IsoSS2Jet","gg":"ggIsoSS","boost":"boostIsoSS","gg200":"ggIsoSS200","boost200":"boostIsoSS200","gg450":"ggIsoSS450","boost450":"boostIsoSS450","vbf":"vbfIsoSS","vbf_gg":"vbf_ggIsoSS","vbf_vbf":"vbf_vbfIsoSS"}
   QCDChannels={"preselection0Jet":"IsoSS0Jet/","preselection":"preselectionSS/","preselectionSS":"notIsoSS/","selectionSS200":"selectionnotIsoSS200/","selectionSS450":"selectionnotIsoSS450/",'boost200':'selectionboostSS200/','boost450':'selectionboostSS450/','gg200':'selectionggSS200/','gg450':'selectionggSS450/',"preselection1Jet":"IsoSS1Jet","preselection2Jet":"IsoSS2Jet","gg":"ggIsoSS","boost":"boostIsoSS","vbf":"vbfIsoSS","vbf_gg":"vbf_ggIsoSS","vbf_vbf":"vbf_vbfIsoSS"}
...
if (highMass and 'collMass_type1' in var and 'boost' in channel) or Ifrebin:
   if MasspointNum==200:
        ...
        binwidth =array.array('d',[0,30,45,60,75,90,105,120,135,150,165,180,195,210,230,250,270,300,330,360,390,425,460,500,540,630,710,810,900,1000,1200,1400])
        ...
        binwidth =array.array('d',[0,20,40,60,80,100,120,140,160,180,200,225,250,280,320,360,390,425,460,500,540,630,710,810,900,1000,1200,1400])
        ...
        binwidth =array.array('d',[0,30,60,90,130,210,290,340,390,425,475,525,590,680,780,880,1000,1400])
   ...
   if MasspointNum==200:
        ...
        binwidth =array.array('d',[0,75,150,170,215,265,325,375,425,475,520,570,620,780,1000,1200,1400])
   elif MasspointNum==600:
        binwidth =array.array('d',[0,50,100,150,200,260,320,390,460,550,630,750,900,1200,1400])
   elif MasspointNum==750:
        binwidth =array.array('d',[0,50,100,150,200,260,320,390,460,540,620,700,800,900,1200,1400])
...
if highMass and ('collMass_type1' in var and "EnWjets" in channel):
        binwidth =array.array('d',[0,30,60,100,150,200,250,300,375,450,525,630,750,1000,1400])
if highMass and ('mMtToPfMet_type1' in var and "EnWjets" in channel):
        binwidth =array.array('d',[0,15,30,45,60,75,90,105,120,135,150,165,180,195,210,230,250,270,300,330,360,390,425,460,500,540,580,630,690,750,810,900,1000,1200,1400])
...
#	do_binbybinQCD(QCDs,lowDataBin,highDataBin)
#        print 'the ratio of wjets and QCDs are   %f' %(QCDs.Integral()/(wjets.Integral()+QCDs.Integral()))
#else:
...
#LFVStack.SetMinimum(0.1)
#LFVStack.Draw('hist')



#wjets.Draw('COLZ')
#wjets.GetYaxis().SetRange(0,200);
#wjets.GetXaxis().SetRange(0,300);
#wjets.GetXaxis().SetTitle('mMtToPfMet')
#wjets.GetYaxis().SetTitle('tMtToPfMet')
#wjets.GetYaxis().SetTitle('tMtToPfMet')
#wjets.GetYaxis().SetTitleOffset(1.5)
#wjets.SetTitle("")
#
...
#    binLow =data.FindBin(300)
#    binHigh = data.FindBin(1400)+1
#if 'preslectionSS' in channel:
#    binLow =data.FindBin(1)
#    binHigh = data.FindBin(1400)+1
#if blinded==False :
...
#    data.Draw("sames,E0")
#for i in range(0,10):
#   print " bin  %f    value  %f"  %(i,)
lfvh = gghmutau200.Clone() 
...
lfvh200.Add(lfvh900)
#if not blinded: 
#  for i in range(1,binContent_2.GetNbinsX()):
#       background=binContent_2.GetBinContent(i)
#       databin=data.GetBinContent(i)
#       background=min(background,databin)
#       if background<1:
#          background=0.00000001
#       signal200=lfvh200.GetBinContent(i)
#       signal300=lfvh300.GetBinContent(i)
#       signal450=lfvh450.GetBinContent(i)
#       signal600=lfvh600.GetBinContent(i)
#       signal750=lfvh750.GetBinContent(i)
#       signal900=lfvh900.GetBinContent(i)
#       signal=max(signal200,signal300,signal450,signal600,signal750,signal900)
#       if (signal/background>0.1):
#          data.SetBinContent(i,-1000000000)
#
lfvh200.Draw('COLZ')
lfvh200.GetYaxis().SetRange(0,200);
lfvh200.GetXaxis().SetRange(0,300);
lfvh200.GetXaxis().SetTitle('mMtToPfMet')
lfvh200.GetYaxis().SetTitle('tMtToPfMet')
lfvh200.GetYaxis().SetTitle('tMtToPfMet')
lfvh200.GetYaxis().SetTitleOffset(1.5)
lfvh200.SetTitle("")
...
#   Masslist[Masspoint].Draw("sames,COLZ")
#elif DrawallMass:
##   lfvh.Draw('hsames')
#   lfvh200.Draw('hsames')
#   lfvh300.Draw('hsames')
...
if not DrawallMass and not DrawselectionLevel_2bin:
    legend.AddEntry(Masslist[Masspoint],'H '+'#rightarrow #mu#tau (B=5%)')
elif DrawallMass:
