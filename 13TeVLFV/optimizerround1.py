...
_0jets = {
   'tPt'  : [30,40,45,50],
  # 'tPt'  : [50],
   'mPt'  : [25,30,35,40,50,55],
  # 'mPt'  : [50,55],
   'deltaPhi' : [3.00,2.80,2.7,2.6,2.5,2.4,2.2,2.0],
  # 'deltaPhi' : [2.1,2.5],
   'tMtToPfMet_type1' : [35,40,50,60,70,80],#was [20,50,10]+[35]
...
_1jets = {
  ...
  #  'mPt'  : [33],
    'tMtToPfMet_type1' : [30,40,45,50,55,60,70,80],
...
_2jets = {
    ...
    'tMtToPfMet_type1' : [30,40,45,50,60,70,80],
    'vbfMass' : [100,150,200,300,350,400,450,550],
