...
backgroundIntegral = zjets.GetBinContent(7)
##if ("vbf" in channel):
...
binLength = zjets.GetBinCenter(2)-zjets.GetBinCenter(1)
...
for i in range(1,size+1):
        ...
        stackBinContent =zjets.GetBinContent(i)
     #   wjetsBinContent = wjets.GetBinContent(i)
        ...
        xUncert.append(zjets.GetBinCenter(i))
        yUncert.append(stackBinContent)
        xUncertRatio.append(zjets.GetBinCenter(i))
...
##		wjetsError = wjets.GetBinError(i)
        eylUncert.append(zjets.GetBinError(i))
        eyhUncert.append(zjets.GetBinError(i))
       ...
       ## eyhUncert.append(wjetsError+zjets.GetBinError(i)+ztautau.GetBinError(i)+ttbar.GetBinError(i)+diboson.GetBinError(i)+singlet.GetBinError(i))
        if (stackBinContent==0):
        	...
        	eylUncertRatio.append(zjets.GetBinError(i))
        	eyhUncertRatio.append(zjets.GetBinError(i))
