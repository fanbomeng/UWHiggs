...
collMass_type1 = ("Collinear Mass [GeV]",20,"ROOT.TLegend(0.63,0.60,0.93,0.97,' ','brNDC')",100,150,True,400,20, "ROOT.TLegend(0.56, 0.5, 0.93, 0.85,' ','brNDC')")
...
mPt = ("#mu p_{T} (GeV)",2,"ROOT.TLegend(0.6,0.55,0.81,0.99,' ','brNDC')",0,0,True,1400,5,"ROOT.TLegend(0.56, 0.5, 0.93, 0.85,' ','brNDC')")
...
tPt = ("#tau_{h} p_{T} (GeV)",2,"ROOT.TLegend(0.55,0.50,0.85,0.87,' ','brNDC')",0,0,True,1400,5,"ROOT.TLegend(0.56, 0.5, 0.93, 0.85,' ','brNDC')")
...
tMtToPfMet_type1 = ("m_{T}(#tau,MET)",2,"ROOT.TLegend(0.58,0.55,0.87,0.95,' ','brNDC')",0,0,True,0,5,"ROOT.TLegend(0.56, 0.5, 0.93, 0.85,' ','brNDC')")
...
type1_pfMetEt = ("MET (GeV)",50,"ROOT.TLegend(0.38,0.55,0.87,0.95,' ','brNDC')",0,0,True,0,0,"ROOT.TLegend(0.56, 0.5, 0.93, 0.85,' ','brNDC')")
