...
#  print "data",data2016BfakesM.GetBinContent(2)
...
#  print "zjets",zjetsfakesM.GetBinContent(2)
  zjetsfakesM.Scale(-1)
...
#  print "ztautau",ztautaufakesM.GetBinContent(2)
...
#  print "ttbar",ttbarfakesM.GetBinContent(2)
