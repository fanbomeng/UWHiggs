...
#	do_binbybinQCD(QCDs,lowDataBin,highDataBin)
     ...
     if QCDflag==True:
        QCDs.Scale(1.06)
#     wjets.Add(QCDs)
if not 'none' in shift and not ('FakeshapeDM' in shift):
   channel=channelSys
...
#smhvbfha=smhvbf.Clone()
#do_binbybinQCD(smhvbfha,0,smhvbfha.GetNbinsX()+1)
#print "***************************************"
#print "VBFHTautau %f" %smhvbfha.Integral()
smhgg = make_histo(savedir,"GluGluHToTauTau_M125_13TeV_powheg_pythia8",channel,var,lumidir,lumi)
#smhggha=smhgg.Clone()
#do_binbybinQCD(smhggha,0,smhggha.GetNbinsX()+1)
#print "GGHTautau %f" %smhggha.Integral()
smhwp = make_histo(savedir,"WplusHToTauTau_M125_13TeV_powheg_pythia8",channel,var,lumidir,lumi)
#smhwpha=smhwp.Clone()
#do_binbybinQCD(smhwpha,0,smhwpha.GetNbinsX()+1)
#print "hwpHTautau %f" %smhwpha.Integral()
smhwm = make_histo(savedir,"WminusHToTauTau_M125_13TeV_powheg_pythia8",channel,var,lumidir,lumi)
#smhwmha=smhwm.Clone()
#do_binbybinQCD(smhwmha,0,smhwmha.GetNbinsX()+1)
#print "hwmHTautau %f" %smhwmha.Integral()
smhzh = make_histo(savedir,"ZHToTauTau_M125_13TeV_powheg_pythia8",channel,var,lumidir,lumi)
#smhzhha=smhzh.Clone()
#do_binbybinQCD(smhzhha,0,smhzhha.GetNbinsX()+1)
#print "hzhHTautau %f" %smhzhha.Integral()
#print "fraction %f"  %((smhwpha.Integral()+smhwmha.Integral()+smhzhha.Integral())/(smhggha.Integral()+smhvbfha.Integral()+smhwpha.Integral()+smhwmha.Integral()+smhzhha.Integral()))
smhvbf.Add(smhwp)
smhvbf.Add(smhwm)
smhvbf.Add(smhzh)
