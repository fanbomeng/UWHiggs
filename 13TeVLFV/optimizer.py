...
#   'deltaPhi' : [2.80,2.70],
 #  'mmetdeltaPhi' : [0.0],
  ...
  # 'tMtToPfMet_type1' :[80,35,70]+ range(40,70,10),#was [20,50,10]+[35]
   'tMtToPfMet_type1' :[75],#was [20,50,10]+[35]
