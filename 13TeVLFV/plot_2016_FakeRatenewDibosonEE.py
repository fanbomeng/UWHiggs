...
dataLoose = make_histo(savedir,"data_SingleElectron_Run2016B",channelLoose,var,True)
dataLooseC = make_histo(savedir,"data_SingleElectron_Run2016C",channelLoose,var,True)
dataLooseD = make_histo(savedir,"data_SingleElectron_Run2016D",channelLoose,var,True)
dataLooseE = make_histo(savedir,"data_SingleElectron_Run2016E",channelLoose,var,True)
dataLooseF = make_histo(savedir,"data_SingleElectron_Run2016F",channelLoose,var,True)
dataLooseG = make_histo(savedir,"data_SingleElectron_Run2016G",channelLoose,var,True)
dataLooseH = make_histo(savedir,"data_SingleElectron_Run2016H",channelLoose,var,True)
...
dataTight = make_histo(savedir,"data_SingleElectron_Run2016B",channelTight,var,True)
dataTightC = make_histo(savedir,"data_SingleElectron_Run2016C",channelTight,var,True)
dataTightD = make_histo(savedir,"data_SingleElectron_Run2016D",channelTight,var,True)
dataTightE = make_histo(savedir,"data_SingleElectron_Run2016E",channelTight,var,True)
dataTightF = make_histo(savedir,"data_SingleElectron_Run2016F",channelTight,var,True)
dataTightG = make_histo(savedir,"data_SingleElectron_Run2016G",channelTight,var,True)
dataTightH = make_histo(savedir,"data_SingleElectron_Run2016H",channelTight,var,True)
...
#  fakeFit1 = ROOT.TF1("adsf","[0]",55,200)
  #fakeFit = ROOT.TF1("adsf","[0]+[1]*x+[2]*x*x",-2.5,2.5)
  #H   fakeRateData1.Fit(fakeFit,"R")
  #H   fakeRateData1.Fit(fakeFit1,"R")
#     fakeRateData1.Fit(fakeFit1,"R")
#     fakeRateData1.Fit(fakeFit2,"R")
#     fakeRateData1.Fit(fakeFit3,"R")
 # fakeRateData1.Fit(fakeFit1,"R")
