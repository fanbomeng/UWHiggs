...
#     wjets.Sumw2()
   ...
   #  do_binbybin(w4jets,"W4JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",lowDataBin,highDataBin)
     ...
     wjets.Add(w3jets)
     wjets.Add(w4jets)
     print "check FakesO Yield: " + str(wjets.Integral())
     print "the path" + savedir


     wjets1 = make_histo(savedir1,"WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channel,var,lumidir,lumi)
#     wjets.Sumw2()
   #  do_binbybin(wjets,"WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",lowDataBin,highDataBin)
     w1jets1 = make_histo(savedir1,"W1JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channel,var,lumidir,lumi)
   #  do_binbybin(w1jets,"W1JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",lowDataBin,highDataBin)
     w2jets1 = make_histo(savedir1,"W2JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channel,var,lumidir,lumi)
   #  do_binbybin(w2jets,"W2JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",lowDataBin,highDataBin)
     w3jets1 = make_histo(savedir1,"W3JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channel,var,lumidir,lumi)
   #  do_binbybin(w3jets,"W3JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",lowDataBin,highDataBin)
     w4jets1 = make_histo(savedir1,"W4JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",channel,var,lumidir,lumi)
   #  do_binbybin(w4jets,"W4JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",lowDataBin,highDataBin)
     wjets1.Add(w1jets1)
     wjets1.Add(w2jets1)
     wjets1.Add(w3jets1)
     wjets1.Add(w4jets1)
     print "check FakesN Yield: " + str(wjets1.Integral())
     print "the path" + savedir1
     if QCDflag==True:
        QCDs.Scale(1.06)
...
#wjets.SetFillColor(6-10)
wjets.SetLineColor(1)
wjets.SetLineWidth(2)
wjets.SetMarkerSize(0)
#wjets1.SetFillColor(210)
wjets1.SetLineColor(2)
wjets1.SetLineWidth(2)
...
if fakeRate == False:
	do_binbybin(wjets,"WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",lowDataBin,highDataBin)
	do_binbybin(wjets1,"WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8",lowDataBin,highDataBin)
	do_binbybinQCD(QCDs,lowDataBin,highDataBin)
else:
...
for i in range(1,size+1):
        ...
        if (fakeRate):
        	   ...
        	   #wjetsError = math.sqrt(((wjets.GetBinContent(i))*0.3*(wjets.GetBinContent(i))*0.3)+((wjets.GetBinError(i))*(wjets.GetBinError(i))))  #here is different from others, why?
                ...
                if (QCDflag == True):
        	    wjetsError = (wjets.GetBinContent(i)*0.25*wjets.GetBinContent(i)*0.25)
                else:
...
#      legend.AddEntry(wjetsMT,'M&T Fakes (jet #rightarrow #mu or #tau)','f')
      ...
      legend.AddEntry(wjets1,'Fakes (jet #rightarrow #tau)','f')
if fakeRate ==False and wjets_fakes==False :
   legend.AddEntry(wjets,'WjetsO','f')
   legend.AddEntry(wjets1,'WjetsN','f')
...
print "FakesO Yield: " + str(wjets.Integral())
print "FakesN Yield: " + str(wjets1.Integral())
