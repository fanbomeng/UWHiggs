...
//  TFile output("HMuTau_mutauhad_2016.input.root", "RECREATE");
  ...
  for (auto b : bins) {
    for (auto m : masses) {
      ...
      //
      //HMuTau_subgg200tPt30_1200_2016_bbb_m200_cardroot30fb_sys
      cb.cp().mass({"200", "*"}).bin({"HMuTau_"+name+"_1200_2016","HMuTau_"+name+"_2200_2016"}).WriteDatacard(folder + "/"+lumi+"/"+"HMuTau_"+name+"_combined_2016"+textbinbybin+"_m200_"+lumi+".txt", output);
//      cb.cp().mass({"125", "*"}).bin({"HMuTau_mutauhad_1_2016","HMuTau_mutauhad_2_2016","HMuTau_mutauhad_3_2016","HMuTau_mutauhad_4_2016"}).WriteDatacard(folder + "/"+lumi+"/"+"HMuTau_mutauhad_combined_2016"+textbinbybin+"_m125_"+lumi+".txt", output);
